...
import FormKategori, { KategoriFormComponent } from "../Forms/FormKategori";
...
export default defineComponent({
  ...
  setup(props) {
    const currentForm = useForm({
      validationSchema: KategoriFormComponent,
    });
    ...
    function submitData(body) {
      ...
      http
        .post("/api/pelanggaran/kategori/create", body, config)
        .then((response) => {
