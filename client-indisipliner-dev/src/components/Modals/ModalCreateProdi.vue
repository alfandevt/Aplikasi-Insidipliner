...
import FormProdi, { ProdiFormComponent } from "../Forms/FormProdi";
...
export default defineComponent({
  ...
  props: {
    title: { type: String, default: "Form Prodi" },
    dismiss: { type: Function },
    submitValue: { type: Function },
  },
  setup(props) {
    const currentForm = useForm({
      validationSchema: ProdiFormComponent,
    });
    ...
    function submitData(body) {
      ...
      http
        .post("/api/akademik/prodi/create", body, config)
        .then((response) => {
