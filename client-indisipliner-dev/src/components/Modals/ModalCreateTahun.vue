...
import FormTahunAjaran, { TahunFormComponent } from "../Forms/FormTahunAjaran";
...
export default defineComponent({
  ...
  setup(props) {
    const currentForm = useForm({
      validationSchema: TahunFormComponent,
    });
    ...
    async function handleSubmit() {
      ...
      if (res.valid) {
        console.log(currentForm.values.tahun_mulai);
    ...
    function submitData(body) {
      ...
      http
        .post("/api/akademik/tahun/create", body, config)
        .then((response) => {
