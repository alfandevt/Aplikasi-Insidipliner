...
import ModalCreateKategori from "../../../components/Modals/ModalCreateKategori";
import ModalInfoKategori from "../../../components/Modals/ModalInfoKategori";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function openCreateModal() {
      await openModal(ModalCreateKategori, {
        title: "Form Kategori",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoKategori, {
        title: "Data Kategori",
        dismiss: closeModal,
        /* user props */
        itemObj: obj,
    ...
    function loadFeed(keyword) {
      ...
      http
        .get("/api/pelanggaran/kategori/list", params)
        .then((response) => {
