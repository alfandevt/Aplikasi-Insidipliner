...
import ModalCreateDosen from "../../../components/Modals/ModalCreateDosen";
import ModalInfoDosen from "../../../components/Modals/ModalInfoDosen";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function openCreateModal() {
      await openModal(ModalCreateDosen, {
        title: "Form Petugas",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoDosen, {
        title: "Data Dosen",
        dismiss: closeModal,
        /* user props */
        userObj: obj,
