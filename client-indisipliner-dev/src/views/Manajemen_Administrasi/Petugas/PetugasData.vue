...
import ModalCreatePetugas from "../../../components/Modals/ModalCreatePetugas";
import ModalInfoPetugas from "../../../components/Modals/ModalInfoPetugas";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function openCreateModal() {
      await openModal(ModalCreatePetugas, {
        title: "Form Petugas",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoPetugas, {
        title: "Data Petugas",
        dismiss: closeModal,
        /* user props */
        userObj: obj,
