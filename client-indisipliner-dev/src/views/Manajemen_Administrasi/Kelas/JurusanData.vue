...
import ModalCreateJurusan from "../../../components/Modals/ModalCreateJurusan";
import ModalInfoJurusan from "../../../components/Modals/ModalInfoJurusan";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function openCreateModal() {
      await openModal(ModalCreateJurusan, {
        title: "Form Jurusan",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoJurusan, {
        title: "Data Jurusan",
        dismiss: closeModal,
        /* user props */
        itemObj: obj,
    ...
    function loadFeed(keyword) {
      ...
      http
        .get("/api/akademik/jurusan/list", params)
        .then((response) => {
