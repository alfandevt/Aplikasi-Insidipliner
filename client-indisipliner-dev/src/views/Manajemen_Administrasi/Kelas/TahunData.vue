...
import ModalCreateTahun from "../../../components/Modals/ModalCreateTahun";
import ModalInfoTahun from "../../../components/Modals/ModalInfoTahun";
...
export default defineComponent({
  ...
  setup() {
    ...
    const title = ref("Data Tahun Akademik");
    ...
    async function openCreateModal() {
      await openModal(ModalCreateTahun, {
        title: "Form Tahun Akademik",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoTahun, {
    ...
    function loadFeed(keyword) {
      ...
      http
        .get("/api/akademik/tahun/list", params)
        .then((response) => {
