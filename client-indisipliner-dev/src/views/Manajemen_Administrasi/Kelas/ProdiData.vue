  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <base-list v-if="!listDataNull" keyName="row_id" v-slot="{ item }">
        <base-item :title="item['prodi']" @btnClick="openInfoModal(item)" />
      </base-list>
...
import ModalCreateProdi from "../../../components/Modals/ModalCreateProdi";
import ModalInfoProdi from "../../../components/Modals/ModalInfoProdi";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function openCreateModal() {
      await openModal(ModalCreateProdi, {
        title: "Form Prodi",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoProdi, {
        title: "Data Prodi",
        dismiss: closeModal,
        /* user props */
        itemObj: obj,
    ...
    function loadFeed(keyword) {
      ...
      http
        .get("/api/akademik/prodi/list", params)
        .then((response) => {
