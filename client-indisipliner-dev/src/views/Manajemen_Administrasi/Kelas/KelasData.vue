...
import ModalCreateKelas from "../../../components/Modals/ModalCreateKelas";
import ModalInfoKelas from "../../../components/Modals/ModalInfoKelas";
...
export default defineComponent({
  ...
  setup() {
    ...
    async function openCreateModal() {
      await openModal(ModalCreateKelas, {
        title: "Form Kelas",
        dismiss: closeModal,
    ...
    async function openInfoModal(obj) {
      await openModal(ModalInfoKelas, {
        title: "Data Kelas",
        dismiss: closeModal,
        /* user props */
        itemObj: obj,
    ...
    function loadFeed(keyword) {
      ...
      http
        .get("/api/akademik/kelas/list", params)
        .then((response) => {
